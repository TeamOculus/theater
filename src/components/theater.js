...
*/}
      ...
      <a-scene>
        <a-assets>
          <a-asset-item id="theater-model" src="http://localhost:8080/src/assets/models/theater/model4.dae"></a-asset-item>
          <a-asset-item id="ferrari" src="http://localhost:8080/src/assets/models/carshow/ferrarif12.dae"></a-asset-item>
          <a-asset-item id="helicopter" src="http://localhost:8080/src/assets/models/carshow/helicopter.dae"></a-asset-item>
